...
if __name__ == '__main__':
    ...
    parser.add_argument('refclkspeed', type=int, help="PCA reference clock speed in Hz, default is 25000000")
    args = parser.parse_args()

    kit = ServoKit(channels=16,reference_clock_speed=args.refclkspeed)
