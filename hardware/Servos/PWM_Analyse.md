## Servo Bug - Analyse des PWM Signals (PCA9685 -----> Servo)
Date: 23.10.2025

Dieses Dokument erklärt, wie durch das`\src\osr-rover-code\scripts\calibrate_servos.py` Script der Winkel des Servos eingestellt wird. Speziell wird hier die Verbindung zwischen dem PCA9685 und dem Servo betrachtet.
...
![Fall1_Screenshot](Images/PWM_Servo0_300deg.png)
...
![Fall1_Screenshot](Images/PWM_Servo0_185deg.png)
